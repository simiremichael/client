...
margin-top: 20px;
`
const AboutAgent = styled.button`
width: 100%;
height: 50px;
font-size: 1.2rem;
outlined: none;
...
`
const MyProperty = styled.button`
width: 100%;
height: 50px;
font-size: 1.2rem;
outlined: none;
...
function AgentDetailsPage() {
  ...
  return (
    <StyledBox>
        ...
        <Grid container>
            ...
            <Grid lg={7} md={7} sm={12} xs={12}>
             ...
             <Position>Real Estate Consultant</Position>
            </Grid>
            </Grid>
            <Grid container>
            <Grid lg={5} md={5} sm={12} xs={12}>
            <InfoTitle>PERSONAL INFORMATION</InfoTitle>
            <Listing>ACTIVE LISTINGS:  <A href='/'>11 porperties</A></Listing>
             <Experience>EXPERIENCE: <Span1>2013</Span1></Experience>
            </Grid>
            <Grid lg={7} md={7} sm={12} xs={12}>
                <Areas>AREA: <Span>Lekki</Span><Span>Vi</Span><Span>Okoyi</Span></Areas>
            </Grid>
            </Grid>
            </Grid>
            <Grid item lg={4} md={4} sm={12} xs={12}>
                <Grid container>
                 <Grid lg={12} md={12} sm={12} xs={12}>
                  <ContactTitle>CONTACT THIS AGENT</ContactTitle>
                  <ButtonContainer>
                  <CallButton type='button'>Call agent</CallButton>
                  <EmailButton type='button'>Email agent</EmailButton>
                  </ButtonContainer>
                 </Grid>
                </Grid>
                <Grid container>
                 ...
                 <CompanyLogo src='../images/reallogo3.jpg' />
                 </Grid>
                 <Grid lg={6} md={6} sm={6} xs={6}>
                 <CompamyMame>Anton Real Estate</CompamyMame>
                 <ViewProfile><a>View Profile</a></ViewProfile>
                 </Grid>
                 </CompanyContainer>
                 </Grid>
                 </Grid>
        ...
        <AboutAgent type='button' style={{  backgroundColor: view1 ? '#008080': '', color: view1 ? 'white': ''   }} onClick={handleView1}>About me</AboutAgent>
        </Grid>
        <Grid item lg={4} md={4} sm={6} xs={6}>
        <MyProperty type='button' style={{ backgroundColor: !view ? '#008080': '', color: !view ? 'white': ''   }} onClick={handleView}>My properties (12)</MyProperty>
        </Grid>
        </ContainerGrid>
        <SortContainer>
        <SortLeftContainer>
   ...
   <AgentDetails>
   A seasoned real estate professional with over 10 years Experience in the field, I recognize and value the trust my clients place in me and I strive every day to exceed their expectations. My sales & closed transactions constantly rank in the top 1% of all my previous companies, which is something that I cherish a lot. Today I proudly represent Ramses Real Estate here in Dubai, looking after exciting properties in Dubai Marina , Palm Jumeirah and Downtown. This is an exciting place to be and if you're looking to list your property soon, I am happy to support you throughout the entire process - just get in touch with me today and I'll take it from there.
   </AgentDetails>
   </AgentDetailsContainer>
     : ''}
        </StyledContainer>
