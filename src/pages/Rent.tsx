...
function Rent() {
  ...
  const initialize = {search: 'i', category: 'rent', type: 'apartment', bed: '4', bath: '4', minPrice: '1000000', maxPrice: '100000000', sort: ''}
...
const page = searchParams.get('page') || 1;
 ...
 const {data} = useSearchPropertiesByRentQuery({ search, category, sort, bed,bath, minPrice, maxPrice, type, page});
