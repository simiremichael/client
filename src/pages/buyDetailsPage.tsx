          ...
          <GridPrice item lg={4} sm={12} md={4} xs={12}>
            ...
            <Links to={`tel:${buyDetail?.phone}`}>
              <CallContainer>
                ...
                <Links to={`mailto:${buyDetail?.email}`}>
              <EmailContainer>
              ...
              <Links to={`https://wa.me/+234${buyDetail?.phone}?text=I'm%20inquiring%20about%20the%20apartment%20listing`}>
              <WhatsAppContainer>
