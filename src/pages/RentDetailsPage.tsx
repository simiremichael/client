...
function DetailsPage() {
  ...
  return (
    <StyledBox>
        <NavBar />
      <StyledContainer>
        <StyledPlink to='/rent'><Plink><Psvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M192 448c-8.188 0-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25l160-160c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l137.4 137.4c12.5 12.5 12.5 32.75 0 45.25C208.4 444.9 200.2 448 192 448z" /></Psvg>Back to search</Plink></StyledPlink>
        <StyledGrid container columnSpacing={0.5}>
          <Grid item lg={8} sm={8} md={8} xs={8}>
            <ListImg1 src='../images/pexels4.jpg' />
            <CameraContainer>
          ...
          <SGrid item lg={4} sm={4} md={4} xs={4}>
            <ListImg2 src='../images/pexels3.jpg' />
            <TourContainer>
              <ImgView src='../images/img-360.png' />
              <Tour>View 360 tour</Tour>
            </TourContainer>
            <ListImg2 src='../images/pexels5.jpg' />
            <VideoContainer>
        ...
        <Grid container>
          <Grid item lg={8} sm={12} md={8} xs={12}>
            <About> APARTMENT FOR IN LEKKI PHASE 1 </About>
            <PropertyInfo>Sea View | Vacant Now | Calm neighbourhood</PropertyInfo>
            <Grid container>
              <LeftContainer item lg={6} sm={6} md={6} xs={6}>
                <Apart><Apsvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M88 104C88 95.16 95.16 88 104 88H152C160.8 88 168 95.16 168 104V152C168 160.8 160.8 168 152 168H104C95.16 168 88 160.8 88 152V104zM280 88C288.8 88 296 95.16 296 104V152C296 160.8 288.8 168 280 168H232C223.2 168 216 160.8 216 152V104C216 95.16 223.2 88 232 88H280zM88 232C88 223.2 95.16 216 104 216H152C160.8 216 168 223.2 168 232V280C168 288.8 160.8 296 152 296H104C95.16 296 88 288.8 88 280V232zM280 216C288.8 216 296 223.2 296 232V280C296 288.8 288.8 296 280 296H232C223.2 296 216 288.8 216 280V232C216 223.2 223.2 216 232 216H280zM0 64C0 28.65 28.65 0 64 0H320C355.3 0 384 28.65 384 64V448C384 483.3 355.3 512 320 512H64C28.65 512 0 483.3 0 448V64zM48 64V448C48 456.8 55.16 464 64 464H144V400C144 373.5 165.5 352 192 352C218.5 352 240 373.5 240 400V464H320C328.8 464 336 456.8 336 448V64C336 55.16 328.8 48 320 48H64C55.16 48 48 55.16 48 64z" /></Apsvg>Property type: <Apartst>Apartment</Apartst></Apart>
                <Bed><Apsvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M176 288C220.1 288 256 252.1 256 208S220.1 128 176 128S96 163.9 96 208S131.9 288 176 288zM544 128H304C295.2 128 288 135.2 288 144V320H64V48C64 39.16 56.84 32 48 32h-32C7.163 32 0 39.16 0 48v416C0 472.8 7.163 480 16 480h32C56.84 480 64 472.8 64 464V416h512v48c0 8.837 7.163 16 16 16h32c8.837 0 16-7.163 16-16V224C640 170.1 597 128 544 128z" /></Apsvg>Bedrooms: <Bedst>2</Bedst></Bed>
              </LeftContainer>
              <RightContainer item lg={6} sm={6} md={6} xs={6}>
                <Size><Apsvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M384 320c-17.67 0-32 14.33-32 32v96H64V160h96c17.67 0 32-14.32 32-32s-14.33-32-32-32L64 96c-35.35 0-64 28.65-64 64V448c0 35.34 28.65 64 64 64h288c35.35 0 64-28.66 64-64v-96C416 334.3 401.7 320 384 320zM488 0H352c-12.94 0-24.62 7.797-29.56 19.75c-4.969 11.97-2.219 25.72 6.938 34.88L370.8 96L169.4 297.4c-12.5 12.5-12.5 32.75 0 45.25C175.6 348.9 183.8 352 192 352s16.38-3.125 22.62-9.375L416 141.3l41.38 41.38c9.156 9.141 22.88 11.84 34.88 6.938C504.2 184.6 512 172.9 512 160V24C512 10.74 501.3 0 488 0z" /></Apsvg>Property Size: <Sizest>1,750 sqt / 163 sqm</Sizest></Size>
          ...
          <GridPrice item lg={4} sm={12} md={4} xs={12}>
            <Price>1,200,000 NGN / yearly</Price>
            <ContactTopContainer>
              <CallContainer>
        ...
        <Grid container>
          <Grid item lg={4} sm={12} md={8} xs={12}>
            ...
            <Grid container>
              ...
              <Grid item lg={6} sm={6} md={6} xs={6}>
                <LocationAddress>Pactum towers, 1220 amadu bello way, Victoria island, Lagos state</LocationAddress>
              </Grid>
            </Grid>
          </Grid>
          <Grid item lg={4} sm={12} md={8} xs={12}>
            ...
            <Grid container>
              ...
              <Grid item lg={6} sm={6} md={6} xs={6}>
                <AgentName><strong>Simire Michael</strong></AgentName>
                <AgentWork>Property Consultant at</AgentWork>
                <AgentCompany>Prestige Real Estate Ltd</AgentCompany>
        ...
        <Grid container>
          <Grid item lg={8} sm={12} md={8} xs={12}>
            ...
            <Grid container>
              <Grid item lg={6} sm={6} md={6} xs={6}>
                <Amenities>Unfurnished</Amenities>
                <Amenities>Built in Wardrobes</Amenities>
                <Amenities>Children's Platy Area</Amenities>
                <Amenities>Maids Room</Amenities>
                <Amenities>Public Pool</Amenities>
              </Grid>
              <Grid item lg={6} sm={6} md={6} xs={6}>
                <Amenities>Balcony</Amenities>
                <Amenities>Central A/C</Amenities>
                <Amenities>Covered Parking</Amenities>
                <Amenities>Public Garden</Amenities>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
            ...
            <Grid container>
              <Grid item lg={12} sm={12} md={12} xs={12}>
                <Description>
                  ...
                  This absolutely stunning three-bedroom with large study family home offers that has been upgraded and modernized throughout, is a rare find. Set on a 6,000 square feet plot this home proudly occupies a prime position in the leafy and quiet Palmera 4 community.
                  This popular roomy floor plan comprises a large open plan living and dining area overlooking the garden. The upgraded closed kitchen is located off the dining room area and flows onto the utility area and maids’ room which has access to the large double garage area.
                  The home is situated very close to the community park and pool and has ample off-street parking for guests.
